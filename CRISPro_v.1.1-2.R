...
if( option == 1 )
{
  ...
  df.chain.resno.resid.prefusion.postfusion.phi.psi.angle.helix.noclashes.distangles.criteriaGYC <- df.chain.resno.resid.prefusion.postfusion.phi.psi.angle.helix.noclashes.distangles.criteriaGYC[ , c( 1:7, 9:16, 18:23 ) ]
